...
namespace TrackerLibrary.DataAccess.TextHelpers
{
    public static class TextConnectorProcessor
    {
        ...
        {
            //id,TournamentName,EntryFee,(id|id|id - Entered Teams),(id|id|id - Prizes),(Rounds - id^id^id|id^id^id|id^id^id - this is list|list and in the list element^element^element|list|list)
        ...
        private static string ConvertRoundListToString(List<List<MatchupModel>> rounds)
        {
            ...
            //this is for do this 2|5|7 - substring stop one character before last pipe and we remove this last pipe
